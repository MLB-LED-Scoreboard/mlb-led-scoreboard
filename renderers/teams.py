...
class TeamsRenderer:
    ...
    def render(self):
        ...
        self.__render_team_score(
            self.away_team.runs, "away", away_colors, away_score_coords["x"], away_score_coords["y"]
        )
        self.__render_team_score(
            self.home_team.runs, "home", home_colors, home_score_coords["x"], home_score_coords["y"]
        )
