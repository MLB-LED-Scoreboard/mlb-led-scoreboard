...
class Schedule:
    ...
    def next_game(self):
        ...
        if (
            ...
            if game_index >= 0:  # we return -1 if no live games for preferred team
                ...
                preferred_game = Game.from_scheduled(scheduled_game, self.config.preferred_game_delay_multiplier)
    ...
    def __current_game(self):
        if self._games:
            ...
            return Game.from_scheduled(scheduled_game, self.config.preferred_game_delay_multiplier)
        return None
